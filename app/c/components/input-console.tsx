...
export default function InputConsole({
  ...
  return (
    <>
      <div
        className="absolute z-10 flex justify-end items-center flex-col w-full h-0 bottom-0"
      ...
      >
        ...
        <div
          className="w-full flex items-start justify-end gap-2 m-4"
