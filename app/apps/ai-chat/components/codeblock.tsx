...
import { sansFontClassname } from "@/constants/font";
  ...
  return match ? (
    <div className="my-2 rounded-lg overflow-hidden">
      <div className="relative w-full text-xs">
        <div
          className={`absolute flex items-center w-full py-0.5 px-4 ${sansFontClassname}`}
    ...
    <code
      className={className || "" + " break-all whitespace-normal"}
      {...props}
    >
      {children}
    </code>
