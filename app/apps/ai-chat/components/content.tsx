...
export default function AiChatContent() {
  ...
  return (
    <div className="overflow-x-visible overflow-y-scroll w-full h-full" ref={_outer} onScroll={outerOnScroll}>
      ...
      <div className="flex-center w-full" ref={_inner}>
        <div className={`flex flex-col w-full py-8 pb-48`}>
          <div className={`${currentThread.length == 0 ? 'py-12' : 'py-4'} mb-4 text-default-300 text-center select-none`}>
            {"Let's start!"}
          </div>
